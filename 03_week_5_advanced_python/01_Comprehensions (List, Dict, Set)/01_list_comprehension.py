# list comprehension is simple and cleaner way to create a new list from an existing iterables eg. list, dict, tuple, sets
#Instead of writing a full loop, you can make it in one line.
